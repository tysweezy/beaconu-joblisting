...
//form instance -- create new connection
...
<form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
		...
		<label for="company">
			<span class="title"><span class="req">*</span>Company</span><input type="text" name="company" placeholder="Company" required>
		</label>
	...
	<label for="email">
		<span class="title"><span class="req">*</span>Email</span><input type="email" name="email" placeholder="Email" required="email">
	</label>
	...
	<label for="description">
		<span class="title">Description</span><textarea name="description" id="" cols="100" rows="7"></textarea>
