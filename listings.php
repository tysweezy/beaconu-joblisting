...
$('.deletePost').click(function(e){
	...
	var ansDel = confirm("Are you sure you want to delete post? You can't undo this.");

	var del_post = $(this).attr('id');
	var myData = 'id='+del_post;
	...
	if (!ansDel) {
		...
		$.ajax({
		  type : 'DELETE',
		  url  : 'http://beaconu.decipherinc.com/listings/apply/'+del_post,
		  data : myData,
